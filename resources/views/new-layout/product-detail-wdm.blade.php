                                ...
                                <div class="" style="margin-top: 20px;margin-bottom: 20px;text-align: center;">
                                    <div class="amount">
                                        ...
                                        <button type="button"
                                            ...
                                            onclick="validarQtd()"><i class="bi bi-check-circle"></i>&nbsp;Participar do sorteio<span id="numberSelectedTotalHome" style="color: #fff;float:right"></span></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="row" style="text-align: center;background-color: #fff; margin-top: 5px; justify-content-center; margin-bottom: 10px;">
                                                <div class="col-12 d-flex justify-content-center">
                                                    <center style="width: 400px;">
                                                        ...
                                                        data-toggle="modal"
                                                        data-target="#staticBackdrop"><i class="bi bi-check-circle"></i>&nbsp;Participar do sorteio
