                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item"
                                                            ...
                                                            target="_blank"><i class="bi bi-list-ul-ol"></i>&nbsp;Ver
                                                            Resumo</a>
                                                        <a class="dropdown-item" href="#"
                                                            onclick="copyResumoLink('{{ route('resumoRifa', $product->id) }}')"><i
                                                                class="bi bi-link-45deg"></i>&nbsp;Copiar Link Resumo</a>
                                                        ...
                                                        <a class="dropdown-item" style="color: green"
                                                            ...
                                                            onclick="definirGanhador('{{ $product->id }}')"><i
                                                                class="bi bi-check-lg"></i>&nbsp;Definir Ganhador</a>
                                                        <a class="dropdown-item" href="javascript:void(0)" title="Ranking"
                                                            onclick="verGanhadores('{{ $product->id }}')"><i
                                                                class="bi bi-people-fill"></i>&nbsp;Visualizar Ganhadores</a>
                                                        <a class="dropdown-item" href="javascript:void(0)"
                                                            title="Duplicar Rifa" data-id="{{ $product->id }}"
                                                            data-name="{{ $product->name }}" onclick="duplicar(this)"><i
                                                                class="far fa-copy"></i>&nbsp;Duplicar Rifa</a>
                                                    </div>
                                            ...
                                            <div class="row mt-2 mb-2">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="number" class="form-control" name="numbers"
                                                        min="1" max="1000000" placeholder="Exemplo: 100" required>
                                                </div>
                                                <div class="col-md-6">
