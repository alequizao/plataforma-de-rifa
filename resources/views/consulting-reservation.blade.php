                            ...
                            <tr>
                                ...
                                @foreach($orderPayedParticipants as $orderParticipant)
                                        ...
                                        <p style="margin-top:1rem;">
                                            <span class="badge text-bg-success"><i class="bi bi-check-circle"></i> PEDIDO#{{$orderParticipant->id}} - PAGAMENTO APROVADO</span>
                                        </p>
                                        <p>COTAS:
                                    ...
                                    @foreach($orderParticipants as $orderParticipant)
                                        @if($orderParticipant->status == "Pendente")
                                            <div style="margin-bottom: 5rem">
                                                <p style="margin-top:1rem;">
                                                    <span class="badge text-bg-warning"><i class="bi bi-clock"></i> PEDIDO#{{$orderParticipant->id}} - AGUARDANDO PAGAMENTO</span>
                                                </p>
                                                <p>COTAS:
