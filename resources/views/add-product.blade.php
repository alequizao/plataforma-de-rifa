...
<div class="container bg-black" style="margin-top: 0px;">
    <div class="row">
        <div class="col-sm-8 bg-primary">
            ...
            <!-- Facebook -->
            <a class="btn btn-primary" style="background-color: #3b5998;width: 50px;" href="#!" role="button"><i class="bi bi-facebook-f" style="font-size: 30px;"></i></a>
            <!-- Instagram -->
            <a class="btn btn-primary" style="background-color: #ac2bac;" href="#!" role="button"><i class="bi bi-instagram" style="font-size: 30px;"></i></a>
            <!-- Whatsapp -->
            <a class="btn btn-primary" style="background-color: #25d366;" href="#!" role="button"><i class="bi bi-whatsapp" style="font-size: 30px;"></i></a>
        </div>
