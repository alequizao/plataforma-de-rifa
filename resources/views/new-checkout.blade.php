...
<style>
    /* fundo definido pelo tema-gemeos.css */
...
@section('content')
                ...
                <section class="title-payment-container mt-2">
                    <section class="title-payment-content">
                        <section class="title-payment-icon">
                            <i class="bi bi-check-circle" id="payment-icon" style="color: #ffc107"></i>
                        </section>
    ...
    <script>
        ...
        const endCountdown = () => {
            ...
            document.getElementById('payment-icon').classList = 'bi bi-x-circle';
