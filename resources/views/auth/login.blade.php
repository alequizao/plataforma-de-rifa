...
@section('content')
    <div class="container">
        ...
        <form class="form-signin" method="POST" action="{{ route('login') }}" style="text-align: center;">
            ...
            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                <label for="email" class="col-md-4 control-label">Usuário ou E-mail</label>
    ...
    margin-right: auto;
    margin-left: auto;">
                    <input id="email" type="text" class="form-control" name="email" autocomplete="username" value="{{ old('email') }}"
                        required autofocus>
