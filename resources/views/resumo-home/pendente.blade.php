    ...
    <div class="container" style="max-width:100%;min-height:100%;">
        ...
        <form action="{{ route('resumo.pendentesSearch') }}" method="POST">
            ...
            <div class="row mt-4 mb-4">
                ...
                <div class="col-md-1">
                    <label></label>
                    <button type="submit" class="btn btn-sm btn-success form-control mt-4"><i class="bi bi-search"></i>&nbsp;Buscar</button>
                </div>
                <div class="col-md-2">
                    <label></label>
            ...
            <div class="row p-1 item-compra reservado">
                ...
                <div class="col-md-3 d-flex align-items-center justify-content-end">
                    <a href="javascript:void(0)" data-id="{{ $participante->id }}" onclick="detalhesParticipante(this)"
                        class="edit btn btn-info float-right mr-1"><i class="bi bi-info-circle"></i></a>
                </div>
            </div>
        @endforeach
