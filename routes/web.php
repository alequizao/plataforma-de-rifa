...
Route::middleware(['check'])->group(function () {
    ...
    Route::group(['middleware' => ['auth', 'isAdmin']], function () {
        Route::get('/clientes-novo', 'HomeAdminController@novoCliente')->name('clientes.novo');
        Route::post('/clientes-novo', 'HomeAdminController@salvarCliente')->name('clientes.salvar');
        ...
        Route::get('/clientes-exportar', 'HomeAdminController@exportarClientes')->name('clientes.exportar');
        Route::delete('/cliente/excluir/{id}', 'HomeAdminController@excluirCliente')->name('clientes.excluir');
        ...
        Route::get('cadastro-videos', 'MySweepstakesController@cadastroVideos')->name('cadastroVideos');
        Route::post('salvar-video', 'MySweepstakesController@salvarVideo')->name('salvarVideo');
        Route::get('excluir-video/{id}', 'MySweepstakesController@excluirVideo')->name('excluirVideo');
        ...
        // Conexão WhatsApp via Baileys (painel multi-dispositivos)
        Route::get('/wpp-mensagens/status', 'HomeAdminController@wppStatus')->name('wpp.status');
        Route::post('/wpp-mensagens/conectar', 'HomeAdminController@wppConectar')->name('wpp.conectar');
        Route::post('/wpp-mensagens/desconectar', 'HomeAdminController@wppDesconectar')->name('wpp.desconectar');
        Route::post('/wpp-mensagens/teste', 'HomeAdminController@wppTeste')->name('wpp.teste');
    ...
    Route::post('cadastra-participante', 'ProductController@bookProductManualy')->name('bookProduct'); // metodo bookProduct nao existe; aponta para o handler real
